...
type Resource struct {
	...
	Completeness resource.Completeness `json:"completeness,omitempty"`
...
func (*Resource) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case resource.FieldAstraID, resource.FieldType, resource.FieldURI, resource.FieldFormat, resource.FieldCompleteness:
	...
	for i := range columns {
		...
		case resource.FieldCompleteness:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.Completeness = resource.Completeness(value.String)
			}
		case resource.FieldCreatedAt:
